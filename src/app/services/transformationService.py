...
class transformationService:
    ...
    def _build_atomic_unit_messages(chunk_text: str, title: str, url: str, topic: str) -> list[dict]:
        user = (
    ...
    def _make_atomic_units(self):
        metadata = self.repo.getExtractionMetadata(self.e_run_ids)